...
namespace MusicApp.ViewModel
{
    public class PlayerViewModel : BaseViewModel
    {
        ...
        public ICommand BackCommand => new Command(() => Application.Current.MainPage.Navigation.PopAsync(true));
        ...
        private async void NextMusic()
        {
            ...
            {
                musicList[currentIndex].IsRecent = false;
